...
function ChipList({ items = [] }) {
  if (!items || items.length === 0) {
    return <span className="text-[#F3E2D4]/50 text-sm">Still learning</span>;
  }
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="border border-[#FC7023]/25 bg-[#281B13]/70 rounded-lg p-4">
          ...
          <ChipList items={profile.favorite_genres} />
        </div>
        ...
        <div className="border border-[#FC7023]/25 bg-[#281B13]/70 rounded-lg p-4">
          ...
          <div className="space-y-3">
            <ChipList items={profile.favorite_directors} />
            <ChipList items={profile.favorite_eras} />
          </div>
        </div>
      </div>
    </motion.section>
